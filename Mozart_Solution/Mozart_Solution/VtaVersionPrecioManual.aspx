<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VtaVersionPrecioManual.aspx.vb" Inherits="VtaVersionPrecioManual" %>
...
<head runat="server">
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table3" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 467px; POSITION: absolute; TOP: 8px; HEIGHT: 136px"
				...
				<TR>
					<TD class="opciones" style="HEIGHT: 2px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:linkbutton id="lbtFichaPropuesta" runat="server" Width="107px">• Ficha Versión</asp:linkbutton></TD>
				</TR>
				<TR>
					<TD style="HEIGHT: 8px">
								...
								<TD style="WIDTH: 296px">
									<asp:datagrid id="dgResumen" runat="server" Width="432px" BorderStyle="None" CssClass="Grid" Height="20px"
										...
										<Columns>
											...
											<asp:BoundColumn DataField="NomSubTipo" HeaderText="Tipo Habitaci&#243;n"></asp:BoundColumn>
