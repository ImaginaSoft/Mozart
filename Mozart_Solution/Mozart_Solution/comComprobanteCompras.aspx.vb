...
Partial Class comComprobanteCompras
    ...
    Private Sub EditaComprobante()
        ...
        Try
            ...
            Do While dr.Read()
                ...
                End If
                txtComisionDescontada.Text = dr.GetValue(dr.GetOrdinal("ComisionDescontada"))
            Loop
            dr.Close()
        Finally
            cn.Close()
    ...
    Private Sub lbltotal_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CalculaMontoDolares()
    End Sub
    ...
    Private Sub lbltotalS_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        CalculaMontoSoles()
    End Sub
    ...
    Protected Sub lbltotal_TextChanged1(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbltotal.TextChanged
        CalculaMontoDolares()
    End Sub

    Protected Sub lbltotalS_TextChanged1(ByVal sender As Object, ByVal e As System.EventArgs) Handles lbltotalS.TextChanged
        CalculaMontoSoles()
    End Sub
End Class
