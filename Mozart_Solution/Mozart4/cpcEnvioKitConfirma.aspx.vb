...
Partial Class cpcEnvioKitConfirma
    ...
    Private Sub CargaDocumentos()
        ...
        ds = objPedido.CargaEnvioKitProgramado
    ...
    Private Sub btnGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        For index As Integer = 0 To dgLista.Rows.Count - 1
            ...
            If cb.Checked Then
                lblmsg.Text = objPedido.ActualizaFchEnvioKit(dgLista.DataKeys(index).Value, objRutina.fechayyyymmdd(txtFchEnvioKit.Text), "E", Session("CodUsuario"))
