...
Partial Class VtaPedidoTareas
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            CargaVendedor()
            ' Carga doble por problema del check box
            CargaTareas()
            'CargaTareas()
        End If
    End Sub
    ...
    Private Sub CargaTareas()
        ...
        lblerror.Text = CStr(dgTarea.Rows.Count) + " Tareas(s) encontrada(s)"
    End Sub
    ...
    Private Sub CargaVendedor()
        ...
        'If Trim(Session("CodUsuario")).Length > 0 Then
        Try
            ddlVendedor.Items.FindByValue(Session("CodUsuario")).Selected = True
        Catch ex As Exception
            '   lblerror.Text = "Vendedor " & ViewState("CodVendedor") & " esta inactivo."
        End Try
        'End If
    End Sub
    ...
    Private Sub cmdCompletar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdCompletar.Click
        ...
        For index As Integer = 0 To dgTarea.Rows.Count - 1
            ...
            If cb.Checked Then
                ...
                lblerror.Text = objVersion.ActualizaStsTarea
            End If
        Next
        CargaTareas()
    End Sub
    ...
    Private Sub cmdGrabrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGrabrar.Click
        ...
        objVersion.NroPropuesta = 0
        objVersion.NroVersion = 0
        objVersion.CodVendedor = ddlVendedor.SelectedItem.Value
        objVersion.FlagFchRevision = ""
        objVersion.CodUsuario = Session("CodUsuario")
