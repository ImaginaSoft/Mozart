<%@ Page Language="VB" AutoEventWireup="false" CodeFile="bolStockCompradoRemision.aspx.vb" Inherits="bolStockCompradoRemision" %>
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 103; LEFT: 8px; WIDTH: 536px; POSITION: absolute; TOP: 8px; HEIGHT: 58px"
				...
				<TR>
					<TD class="Titulo" style="HEIGHT: 19px">Remisión de Boletos</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD style="HEIGHT: 128px">
						<TABLE class="tabla" id="Table2" style="WIDTH: 584px; HEIGHT: 112px" borderColor="#cccccc"
							cellSpacing="0" cellPadding="0" width="584" border="1">
							<TR>
								<TD style="WIDTH: 144px">N° Pedido donde aplica como pago (TAB)</TD>
								<TD>
									<asp:TextBox id="txtNroPedido" runat="server" Width="106px" MaxLength="8" AutoPostBack="True"></asp:TextBox>&nbsp;
							...
							<TR>
								<TD style="WIDTH: 144px">Fecha de la Remisión</TD>
								<TD>
									<asp:textbox id="txtFchEmision" runat="server" Width="75px" CssClass="fd" ReadOnly="True" Enabled="False"
										BackColor="#C0FFFF"></asp:textbox></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 144px">Monto de la Remisión</TD>
								<TD>
									<asp:TextBox id="txtMontoRemision" runat="server" Width="106px" MaxLength="12"></asp:TextBox></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
