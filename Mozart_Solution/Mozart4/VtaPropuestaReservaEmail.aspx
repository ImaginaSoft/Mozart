<%@ Page Language="VB" ValidateRequest="false" AutoEventWireup="false" CodeFile="VtaPropuestaReservaEmail.aspx.vb" Inherits="VtaPropuestaReservaEmail" %>
...
<head runat="server">
	...
	<body onload="LoadDiv()" MS_POSITIONING="GridLayout">
		<TABLE id="Table2" style="Z-INDEX: 107; LEFT: 16px; WIDTH: 542px; POSITION: absolute; TOP: 160px; HEIGHT: 338px; BACKGROUND-COLOR: white"
		...
		<form id="frmRTB" method="post" runat="server">
			<TABLE class="tabla" id="Table1" style="Z-INDEX: 102; LEFT: 16px; WIDTH: 542px; POSITION: absolute; TOP: 39px; HEIGHT: 97px"
				cellSpacing="0" cellPadding="0" width="542" border="0">
				<TR>
					<TD style="WIDTH: 48px; HEIGHT: 24px"></TD>
					<TD style="HEIGHT: 24px" align="left"><asp:label id="lblmsg" runat="server" CssClass="error" Width="472px"></asp:label></TD>
				</TR>
				<TR>
			...
			<asp:textbox id="txtRTB" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 544px" runat="server"
				Width="8px" Height="4px"></asp:textbox></form>
</body>
</html>
