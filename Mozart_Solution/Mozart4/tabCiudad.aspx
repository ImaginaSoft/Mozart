<%@ Page Language="VB" AutoEventWireup="false" CodeFile="tabCiudad.aspx.vb" Inherits="tabCiudad" %>
...
<head runat="server">
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<TABLE class="form" id="Table4" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 584px; POSITION: absolute; TOP: 8px; HEIGHT: 340px"
				...
				<TR>
					<TD style="WIDTH: 467px"><asp:label id="lblMsg" runat="server" Width="311px" 
                            CssClass="msg"></asp:label></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 467px"><asp:datagrid id="dgCiudad" runat="server" Width="576px" CssClass="Grid" Height="25px" BorderColor="CadetBlue"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="">
									<ItemTemplate>
										<asp:HyperLink id="Hyperlink2" runat="server" Text='Clima' NavigateUrl='<%# "tabCiudadClima.aspx?CodCiudad=" + cstr(DataBinder.Eval(Container.DataItem,"CodCiudad"))%>'>
										</asp:HyperLink>
									</ItemTemplate>
								</asp:TemplateColumn>
