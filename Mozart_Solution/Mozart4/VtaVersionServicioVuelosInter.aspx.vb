...
Partial Class VtaVersionServicioVuelosInter
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            lblTitulo.Text = "Versión N° " & ViewState("NroVersion") & " - Vuelos Internacionales"
    ...
    Private Sub CargaData()
        ...
        Else
            'lblMsg.Text = "La Versión está publicada, no se puede modificar los Servicios"
            lblMsg.Text = "Opción válida para Versión Facturad"
            cmdGrabar.Visible = False
            dgServicio.Columns(0).Visible = False
            dgServicio.Columns(13).Visible = False
    ...
    Private Sub cmdGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGrabar.Click
        ...
        If txtNroServicioAnt.Text = 5644 Or txtNroServicioAnt.Text = 5645 Then

        Else
            lblMsg.Text = "Solo servicios de vuelos internacionales"
            Return
        End If
    ...
    Private Sub dgServicio_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles dgServicio.SelectedIndexChanged
        ...
        If dgServicio.Items(dgServicio.SelectedIndex).Cells(4).Text.Trim = 5644 Or dgServicio.Items(dgServicio.SelectedIndex).Cells(4).Text.Trim = 5645 Then

        Else
            lblMsg.Text = "Solo está permitido editar servicios de vuelos internacionales"
            Return
        End If
    ...
    Private Sub dgServicio_DeleteCommand(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dgServicio.DeleteCommand
        ...
        If Mid(dgServicio.DataKeys(e.Item.ItemIndex), 17, 8) = 5644 Or Mid(dgServicio.DataKeys(e.Item.ItemIndex), 17, 8) = 5645 Then

        Else
            lblMsg.Text = "Solo está permitido eliminar servicios de vuelos internacionales"
            Return
        End If
