<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VtaVersionCambiarHotel.aspx.vb" Inherits="VtaVersionCambiarHotel" %>
				...
				<TR>
					<TD style="HEIGHT: 94px">
						<TABLE class="tabla" id="Table1" style="WIDTH: 576px; HEIGHT: 50px" borderColor="#cccccc"
							...
							<TR>
								<TD style="WIDTH: 121px; HEIGHT: 19px">Nuevo Servicio</TD>
								<TD style="HEIGHT: 19px"><asp:dropdownlist id="ddlServicio" runat="server" Width="424px" DataTextField="DesProveedor" DataValueField="NroServicio"
										AutoPostBack="True"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 121px; HEIGHT: 15px"><asp:label id="lblTipoAcomodacion" runat="server" Width="112px">Tipo Acomodación</asp:label></TD>
								<TD style="HEIGHT: 15px"><asp:dropdownlist id="ddlTipoAcomodacion" runat="server" Width="288px" DataTextField="TipoAcomodacion"
					...
					<TD style="HEIGHT: 14px">
						<TABLE class="tabla" id="Table2" style="WIDTH: 576px; HEIGHT: 32px" borderColor="#cccccc"
							...
							<TR>
								...
								<TD style="WIDTH: 149px" align="left">&nbsp;&nbsp;&nbsp;<asp:radiobutton id="rbtUpdate" runat="server" Checked="True" GroupName="G1" Text="Reemplazar"></asp:radiobutton></TD>
