...
Partial Class tabZonaVtaInf
    ...
    Dim objZonaVtaInf As New clsZonaVtaInf
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            lblTitulo.Text = "Información - Zona de Venta "

            lblMsg.Text = objZonaVta.Editar(Viewstate("CodZonaVta"))
            If lblMsg.Text.Trim = "OK" Then
                lblTitulo.Text = lblTitulo.Text & " " & objZonaVta.NomZonaVta
            End If
    ...
    Private Sub CargaDatos()
        Dim ds As New DataSet
        ds = objInformacion.CargarxZonaVta(Viewstate("CodZonaVta"))
    ...
    Private Sub cmdGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGrabar.Click
        If ddlInformacion.Items.Count = 0 Then
            ...
            Return
        End If
        objZonaVtaInf.CodZonaVta = Viewstate("CodZonaVta")
        objZonaVtaInf.NroInformacion = ddlInformacion.SelectedItem.Value
        objZonaVtaInf.CodUsuario = Session("CodUsuario")
        lblMsg.Text = objZonaVtaInf.Grabar()
        If lblMsg.Text.Trim = "OK" Then
            CargaDatos()
        Else
    ...
    Private Sub dgLista_DeleteCommand1(ByVal source As Object, ByVal e As System.Web.UI.WebControls.DataGridCommandEventArgs) Handles dglista.DeleteCommand
        lblMsg.Text = objZonaVtaInf.Borrar(Viewstate("CodZonaVta"), dglista.DataKeys(e.Item.ItemIndex))
        If lblMsg.Text.Trim = "OK" Then
            CargaDatos()
        Else
            lblMsg.CssClass = "Error"
