<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VtaVersionEspeci.aspx.vb" Inherits="VtaVersionEspeci" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE class="form" id="Table3" style="Z-INDEX: 101; LEFT: 10px; WIDTH: 589px; POSITION: absolute; TOP: 7px; HEIGHT: 22px"
				...
				<TR>
					<TD><asp:datagrid id="dgServicio" runat="server" Width="750px" BorderStyle="None" Height="20px" CssClass="Grid"
