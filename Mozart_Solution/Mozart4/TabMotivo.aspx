<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TabMotivo.aspx.vb" Inherits="TabMotivo" %>
...
<head runat="server">
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table4" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 536px; POSITION: absolute; TOP: 8px; HEIGHT: 136px"
				cellSpacing="0" cellPadding="1" width="536" border="0" class="form">
				<TR>
					<TD class="Titulo" style="WIDTH: 467px">
						<asp:Label id="lblTitulo" runat="server">Motivos de Anulación del Pedido</asp:Label></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD style="WIDTH: 467px">
						<asp:label id="lblMsg" runat="server" Width="528px" CssClass="error" Height="17px"></asp:label></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 467px">
						<asp:datagrid id="dglista" runat="server" Width="544px"   Height="17px" CellPadding="2"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="CodMotivo" SortExpression="CodMotivo" HeaderText="C&#243;digo">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="NomMotivo" SortExpression="NomMotivo" HeaderText="Nombre">
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="StsMotivo" SortExpression="StsMotivo" HeaderText="Estado">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
