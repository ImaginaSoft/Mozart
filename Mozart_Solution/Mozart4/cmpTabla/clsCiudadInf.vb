...
Public Class clsCiudadInf
    ...
    Function Grabar() As String
        ...
        cd.Connection = cn
        cd.CommandText = "TAB_CiudadInf_I"
    ...
    Function Borrar(ByVal pCodCiudad As String, ByVal pNroInformacion As Integer) As String
        Dim cn As New SqlConnection(System.Configuration.ConfigurationManager.AppSettings("cnMozart"))
        Dim cd As New SqlCommand
        cd.Connection = cn
        cd.CommandText = "TAB_CiudadInf_D"
        cd.CommandType = CommandType.StoredProcedure
