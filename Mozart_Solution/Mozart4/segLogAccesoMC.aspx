<%@ Page Language="VB" AutoEventWireup="false" CodeFile="segLogAccesoMC.aspx.vb" Inherits="segLogAccesoMC" %>
	...
	<body >
        ...
        <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
			...
			<TABLE id="Table3" style="Z-INDEX: 101; LEFT: 15px; WIDTH: 589px; POSITION: absolute; TOP: 6px; HEIGHT: 22px"
				...
				<TR>
					<TD>
						<P class="Titulo">Log de&nbsp;Accesos&nbsp;a MasterCard</P>
					</TD>
				</TR>
				<TR>
					<TD>
				...
				<TR>
					<TD><asp:datagrid id="dgLog" runat="server" Width="780px" CssClass="Grid" Height="17px" AllowSorting="True"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="I2NroOrdenPago" SortExpression="I2NroOrdenPago" HeaderText="Orden" DataFormatString="{0:#########}">
								...
								<asp:BoundColumn DataField="I3MonOrdenPago" SortExpression="I3MonOrdenPago" HeaderText="Monto USD" DataFormatString="{0:###,###,###,###.##}">
									<ItemStyle HorizontalAlign="Right"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="RptaMC" SortExpression="RptaMC" HeaderText="Rpta MC">
								...
								<asp:BoundColumn DataField="O15NroTarjeta" SortExpression="O15NroTarjeta" HeaderText="Tarjeta">
									<ItemStyle BackColor="#CCFFFF"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="O9Monto" SortExpression="O9Monto" HeaderText="Importe Autorizado"
									DataFormatString="{0:###,###,###,###.##}">
									<ItemStyle HorizontalAlign="Center" BackColor="#CCFFFF"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="O2CodAutoriza" SortExpression="O2CodAutoriza" HeaderText="Codigo Autoriza">
									<ItemStyle HorizontalAlign="Center" BackColor="#CCFFFF"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="O13CodRpta" SortExpression="O13CodRpta" HeaderText="CodRpta">
									<ItemStyle BackColor="#CCFFFF"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="O17MsgRpta" SortExpression="O17MsgRpta" HeaderText="MsgRpta">
									<ItemStyle BackColor="#CCFFFF"></ItemStyle>
								</asp:BoundColumn>
