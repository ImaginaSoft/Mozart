<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VtaVersionBoletoTerrestre.aspx.vb" Inherits="VtaVersionBoletoTerrestre" %>
				...
				<TR>
					<TD>
						<TABLE class="Tabla" id="Table1" style="WIDTH: 616px; HEIGHT: 81px" borderColor="#cccccc"
							...
							<TR>
								<TD style="WIDTH: 140px; HEIGHT: 25px">&nbsp;Empresa&nbsp;</TD>
							...
							<TR>
								<TD style="WIDTH: 140px; HEIGHT: 5px">&nbsp;Número boleto</TD>
					...
					<TD style="HEIGHT: 25px">
						<asp:datagrid id="dgServicio" runat="server" Width="1140px" Height="17px" CssClass="Grid" BorderStyle="None"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="aerolinea" HeaderText="Empresa">
									<ItemStyle BackColor="#CCFFFF"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="NroVuelo" HeaderText="N&#250;mero Boleto">
									<ItemStyle BackColor="#CCFFFF"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="FchVuelo" HeaderText="Fecha Boleto" DataFormatString="{0:dd-MM-yyyy}">
									<ItemStyle BackColor="#CCFFFF"></ItemStyle>
								</asp:BoundColumn>
