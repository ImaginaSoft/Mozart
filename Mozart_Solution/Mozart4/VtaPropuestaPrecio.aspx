<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VtaPropuestaPrecio.aspx.vb" Inherits="VtaPropuestaPrecio" %>
...
<head runat="server">
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table3" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 611px; POSITION: absolute; TOP: 8px; HEIGHT: 160px"
				...
				<TR>
					<TD style="HEIGHT: 21px">
						<TABLE id="Table2" cellSpacing="0" cellPadding="0" width="300" border="0">
							<TR>
								<TD class="form" style="WIDTH: 296px; HEIGHT: 17px">
									Precio por Tipo</TD>
							</TR>
							<TR>
								<TD style="WIDTH: 296px"><asp:datagrid id="dgResumen" runat="server" Width="432px" BorderStyle="None" CssClass="Grid" Height="20px"
				...
				<TR>
					<TD style="HEIGHT: 7px">
						<TABLE id="Table4" style="WIDTH: 544px; HEIGHT: 20px" cellSpacing="0" cellPadding="0" width="544"
							...
							<TR>
								<TD class="form" style="WIDTH: 296px; HEIGHT: 17px">
									Precios para mostrar al Cliente</TD>
								<TD style="WIDTH: 296px; HEIGHT: 17px"></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 296px"><asp:datagrid id="dgPrecio" runat="server" Width="432px" BorderStyle="None" CssClass="Grid" Height="20px"
										BorderColor="CadetBlue" AutoGenerateColumns="False" BorderWidth="2px" CellPadding="2" OnItemDataBound="ComputeSumP"
										ShowFooter="True">
										<SelectedItemStyle CssClass="GridSelect"></SelectedItemStyle>
										<AlternatingItemStyle CssClass="GridAlterna"></AlternatingItemStyle>
										<ItemStyle CssClass="GridData"></ItemStyle>
					...
					<TD style="HEIGHT: 21px">
						<TABLE class="tabla" id="Table1" style="WIDTH: 544px; HEIGHT: 32px" cellSpacing="1" cellPadding="1"
							...
							<TR>
								...
								<TD style="WIDTH: 39px; HEIGHT: 23px"><asp:textbox id="txtRangoTarifa" runat="server" Width="30px"></asp:textbox></TD>
								...
								<TD style="WIDTH: 41px; HEIGHT: 23px"><asp:textbox id="txtCantSolicita" runat="server" Width="30px"></asp:textbox></TD>
								...
								<TD style="HEIGHT: 23px"><asp:textbox id="txtCantPersonas" runat="server" Width="30px"></asp:textbox></TD>
								<TD style="HEIGHT: 23px"><asp:button id="cmdGrabar" runat="server" Width="68px" Text="Grabar"></asp:button></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
				...
				<TR>
					<TD style="HEIGHT: 20px"><asp:GridView id="dgServicio" runat="server" Width="800px" CssClass="Grid" Height="24px" BorderColor="CadetBlue"
							AutoGenerateColumns="False" BorderWidth="1px" CellPadding="2" DataKeyNames="KeyReg" UseAccessibleHeader="False">
							...
							<Columns>
								...
								<asp:BoundField DataField="CantSolicita" HeaderText="Cant. Tipo" DataFormatString="{0:####}">
									<ItemStyle HorizontalAlign="Center" BackColor="White"></ItemStyle>
								</asp:BoundField>
