<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VtaPedidosxFchRevision.aspx.vb" Inherits="VtaPedidosxFchRevision" %>
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table3" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 620px; POSITION: absolute; TOP: 8px; HEIGHT: 176px"
				...
				<TR>
					<TD>
						<P class="Titulo">&nbsp;Pedidos por Fecha de última Tarea Completada</P>
					</TD>
				</TR>
				<TR>
					<TD style="HEIGHT: 1px">
						<TABLE class="tabla" id="Table1" style="WIDTH: 544px; HEIGHT: 60px" borderColor="#cccccc"
							...
							<TR>
								...
								<TD style="WIDTH: 296px; HEIGHT: 15px"><asp:dropdownlist id="ddlVendedor" runat="server" Width="298px" DataTextField="NomVendedor" DataValueField="CodVendedor"></asp:dropdownlist></TD>
								<TD style="HEIGHT: 15px"></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 116px; HEIGHT: 23px">Estado&nbsp; Pedido</TD>
								<TD style="WIDTH: 296px; HEIGHT: 23px"><asp:dropdownlist id="ddlEstadoPedido" 
                                        runat="server" Width="296px"></asp:dropdownlist></TD>
								<TD style="HEIGHT: 23px">&nbsp;&nbsp;&nbsp;
								</TD>
							</TR>
							<TR>
								<TD style="WIDTH: 116px">Fecha de tarea completada del</TD>
								<TD style="WIDTH: 296px"><asp:textbox id="txtFchInicial" runat="server" Width="75px" DESIGNTIMEDRAGDROP="21" CssClass="fd"
				...
				<TR>
					<TD><asp:datagrid id="dgPedidos" runat="server" Width="585px" Height="17px" CssClass="Grid" BorderColor="CadetBlue"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="FchRevision" SortExpression="FchRevision" HeaderText="Ult.Tarea Completada"
									DataFormatString="{0:dd-MM-yy}">
									<ItemStyle Wrap="False" HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="FchProximaRevision" SortExpression="FchProximaRevision" HeaderText="Pr&#243;xima Tarea"
									DataFormatString="{0:dd-MM-yy}">
								...
								<asp:BoundColumn DataField="NomStsCaptacion" SortExpression="NomStsCaptacion" HeaderText="Perfil ">
									<ItemStyle HorizontalAlign="Left"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="AnoMesAtencion" SortExpression="AnoMesAtencion" HeaderText="Atenci&#243;n"></asp:BoundColumn>
								<asp:BoundColumn DataField="MsgSal" SortExpression="MsgSal" HeaderText="Msg Salida">
									<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="MsgEnt" SortExpression="MsgEnt" HeaderText="Msg Entrada">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="IngWeb" SortExpression="IngWeb" HeaderText="Ingreso Web">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								...
								<asp:BoundColumn DataField="NroPedido" SortExpression="NroPedido" HeaderText="NroPedido">
