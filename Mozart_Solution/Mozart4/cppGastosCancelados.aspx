<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cppGastosCancelados.aspx.vb" Inherits="cppGastosCancelados" %>
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<TABLE class="form" id="Table2" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 786px; POSITION: absolute; TOP: 8px; HEIGHT: 68px"
				...
				<TR>
					<TD class="Titulo" style="HEIGHT: 19px">&nbsp;Gastos por&nbsp;mes&nbsp;en US$</TD>
				</TR>
				<TR>
