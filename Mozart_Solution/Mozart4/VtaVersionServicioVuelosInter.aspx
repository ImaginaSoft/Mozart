<%@ Page Language="VB" AutoEventWireup="false" CodeFile="VtaVersionServicioVuelosInter.aspx.vb" Inherits="VtaVersionServicioVuelosInter" %>
					...
					<TD style="HEIGHT: 157px">
						<TABLE class="tabla" id="Table1" style="WIDTH: 832px; HEIGHT: 238px" borderColor="#cccccc"
							...
							<TR>
								...
								<TD style="HEIGHT: 17px"><asp:dropdownlist id="ddlProveedor" tabIndex="1" 
                                        runat="server" Width="384px" AutoPostBack="True"
										DataValueField="CodProveedor" DataTextField="NomProveedor" Enabled="False"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 121px; HEIGHT: 15px">Ciudad</TD>
								<TD style="HEIGHT: 15px"><asp:dropdownlist id="ddlCiudad" runat="server" 
                                        Width="384px" AutoPostBack="True" DataValueField="CodCiudad"
										DataTextField="NomCiudad" Enabled="False"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 121px; HEIGHT: 17px">Tipo Servicio</TD>
								<TD style="HEIGHT: 17px"><asp:dropdownlist id="ddltiposervicio" runat="server" 
                                        Width="384px" AutoPostBack="True" DataValueField="CodTipoServicio"
										DataTextField="TipoServicio" Enabled="False"></asp:dropdownlist></TD>
							</TR>
							<TR>
					...
					<TD style="HEIGHT: 14px">
						<TABLE class="tabla" id="Table2" style="WIDTH: 576px; HEIGHT: 32px" borderColor="#cccccc"
							...
							<TR>
								...
								<TD style="WIDTH: 161px" align="left"><asp:radiobutton id="rbtNuevo" runat="server" 
                                        GroupName="G1" Text="Nuevo" Checked="True"></asp:radiobutton></TD>
								<TD style="WIDTH: 161px" align="left"><asp:radiobutton id="rbtUpdate" 
                                        runat="server" Text="Reemplazar" GroupName="G1"></asp:radiobutton></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
