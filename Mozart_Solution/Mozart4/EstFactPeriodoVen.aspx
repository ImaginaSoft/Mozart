<%@ Page Language="VB" AutoEventWireup="false" CodeFile="EstFactPeriodoVen.aspx.vb" Inherits="EstFactPeriodoVen" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table4" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 507px; POSITION: absolute; TOP: 8px; HEIGHT: 156px"
				...
				<TR>
					<TD>
						<P class="Titulo">Ventas por Periodo</P>
					</TD>
				</TR>
				<TR>
					<TD>
...
&nbsp;Año</td>
                            ...
                            <tr>
                                <td>
                                    Periodo</td>
                                <td>
                                                <asp:dropdownlist id="ddlPeriodoVtas" runat="server" Width="250px" 
                                                    DataTextField="Periodo" DataValueField="FchFinPeriodo" 
				...
				<TR>
					<TD><asp:GridView id="dgLista" runat="server" Height="24px" Width="550px" 
							...
							<Columns>
								<asp:BoundField DataField="FchFinPeriodo"  HeaderText="Fecha Fin Periodo" DataFormatString="{0:dd-MM-yyyy}">
