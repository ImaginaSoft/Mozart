...
Partial Class VtaVersionBoletoReserva
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If Not Page.IsPostBack Then
            ...
            lblTitulo.Text = "Estado Reserva de Boletos - Versión N° " & Viewstate("NroVersion")
            CargaBoletos()
    ...
    Private Sub CargaBoletos()
        ...
        ds = ObjVersionDet.CargarBoletos(Viewstate("NroPedido"), Viewstate("NroPropuesta"), Viewstate("NroVersion"))
    ...
    Private Sub cmdGrabar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdGrabar.Click
        ...
        If ddlStsReserva.SelectedItem.Value = "OK" Then
            ...
            If txtAerolinea.Text.Trim.Length = 0 Then
                lblMsg.Text = "Falta ingresar Linea Aérea"
                Return
            End If
            If txtNroVuelo.Text.Trim.Length = 0 Then
                lblMsg.Text = "Falta ingresar Nro Vuelo"
                Return
            End If
            If txtRutaVuelo.Text.Trim.Length = 0 Then
                lblMsg.Text = "Falta ingresar Ruta de Vuelo"
                Return
            End If
        ...
        ObjVersionDet.CodReserva = txtCodReserva.Text
