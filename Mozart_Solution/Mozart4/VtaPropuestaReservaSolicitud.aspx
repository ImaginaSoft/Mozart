<%@ Page Language="VB" ValidateRequest="false" AutoEventWireup="false" CodeFile="VtaPropuestaReservaSolicitud.aspx.vb" Inherits="VtaPropuestaReservaSolicitud" %>
			...
			<TABLE class="tabla" id="Table1" style="Z-INDEX: 102; LEFT: 16px; WIDTH: 542px; POSITION: absolute; TOP: 32px; HEIGHT: 96px"
				...
				<TR>
					...
					<TD style="HEIGHT: 9px" align="left">
						<asp:dropdownlist id="ddlSolicita" tabIndex="6" runat="server" Width="248px" DataTextField="NomSolicita"
							DataValueField="CodSolicita" AutoPostBack="True"></asp:dropdownlist></TD>
				</TR>
				<TR>
