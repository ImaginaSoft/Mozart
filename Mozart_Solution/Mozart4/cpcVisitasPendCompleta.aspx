<%@ Page Language="VB" ValidateRequest="false" AutoEventWireup="false" CodeFile="cpcVisitasPendCompleta.aspx.vb" Inherits="cpcVisitasPendCompleta" %>
...
<head runat="server">
	...
	<body onload="LoadDiv()" >
		<TABLE id="Table5" style="Z-INDEX: 101; LEFT: 16px; WIDTH: 563px; POSITION: absolute; TOP: 248px; HEIGHT: 350px; BACKGROUND-COLOR: white"
			height="350" width="563" align="center" border="1">
			...
			<TR>
				<TD style="HEIGHT: 180px">
					<DIV id="TextEditor" contentEditable="true" style="OVERFLOW: auto; WIDTH: 552px; HEIGHT: 214px; WORD-WRAP: break-word"
		...
		<form id="frmRTB" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 8px; WIDTH: 625px; POSITION: absolute; TOP: 8px; HEIGHT: 208px"
				cellSpacing="0" cellPadding="0" width="625" border="0" class="Form">
				<TR>
					<TD class="Titulo">Actualiza datos de la Visita</TD>
				</TR>
				<TR>
					<TD>
						<TABLE class="tabla" id="Table3" style="WIDTH: 624px; HEIGHT: 192px" cellSpacing="0" cellPadding="0"
							width="624" border="1" borderColor="#cccccc">
							<TR>
								<TD style="WIDTH: 106px; HEIGHT: 18px">Nro Pedido</TD>
								<TD style="HEIGHT: 18px">
									<asp:label id="lblNroPedido" runat="server" Width="46px"></asp:label>&nbsp;
									<asp:label id="lblDesPedido" runat="server" Width="404px"></asp:label></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 106px; HEIGHT: 2px">Cliente</TD>
								<TD style="HEIGHT: 2px">
									<asp:label id="lblNomCliente" runat="server" Width="175px"></asp:label></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 106px">Vendedor</TD>
								<TD>
									<TABLE class="tabla" id="Table4" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD style="WIDTH: 233px">
												<asp:label id="lblNomVendedor" runat="server" Width="172px"></asp:label></TD>
											<TD>Tipo Visita&nbsp; &nbsp;
												<asp:label id="lblTipo" runat="server" Width="171px"></asp:label></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
							<TR>
								<TD style="WIDTH: 106px; HEIGHT: 18px">Pax</TD>
								<TD style="HEIGHT: 18px">
									<asp:textbox id="txtPax" runat="server" Width="74px" MaxLength="3"></asp:textbox></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 106px">Fecha Visita</TD>
								<TD>
									<TABLE class="tabla" id="Table2" cellSpacing="0" cellPadding="0" width="100%" border="0">
										<TR>
											<TD style="WIDTH: 233px">
												<asp:textbox id="txtFchVisita" runat="server" Width="75px" CssClass="fd"></asp:textbox><INPUT class="fd" id="cmdFchNacimiento" style="WIDTH: 26px; HEIGHT: 24px" onclick="show_calendar('frmRTB.txtFchVisita',null,null,'DD-MM-YYYY','POPUP','Nav=Yes;SmartNav=Yes;AllowWeekends=Yes');"
													tabIndex="2" type="button" value="..." name="cmdFchEmision"></TD>
											<TD>Hora Visita&nbsp;
												<asp:textbox id="txtHoraVisita" runat="server" Width="74px" MaxLength="8"></asp:textbox>&nbsp;
							...
							<TR>
								<TD style="WIDTH: 106px">Responsable</TD>
								<TD>
									<asp:dropdownlist id="ddlVendedor" runat="server" Width="187px" DataValueField="CodVendedor" DataTextField="NomVendedor"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 106px">Evaluación</TD>
								<TD>
									<asp:dropdownlist id="ddlEvaluacion" runat="server" Width="409px" DataValueField="CodEvaluacion" DataTextField="NomEvaluacion"></asp:dropdownlist></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 106px">Cantidad&nbsp;día libre</TD>
								<TD>
									<asp:textbox id="txtCantDiaLibre" runat="server" Width="56px" MaxLength="6"></asp:textbox></TD>
							</TR>
						</TABLE>
						<asp:label id="lblmsg" runat="server" Width="552px" CssClass="Error" ></asp:label></TD>
				</TR>
			</TABLE>
			<asp:button id="cmdGrabar" style="Z-INDEX: 103; LEFT: 208px; POSITION: absolute; TOP: 608px"
				runat="server" Width="80px" Text="Grabar"></asp:button>
			<asp:textbox id=txtRTB style="Z-INDEX: 103; LEFT: 24px; POSITION: absolute; TOP: 600px" runat="server" Width="8px" Height="4px" Text='<%# DataBinder.Eval(dsEdit, "Tables[DLOGPROVEEDOR].DefaultView.[0].deslog") %>'>
			</asp:textbox>
		</form>
<p>
		<OBJECT style="Z-INDEX: 105; LEFT: 639px; POSITION: absolute; TOP: 169px; height: 14px; width: 10px;" 
