<%@ Page Language="VB" AutoEventWireup="false" CodeFile="comComprobanteCompras.aspx.vb" Inherits="comComprobanteCompras" %>
...
<head runat="server">
	...
	<BODY >
		<FORM id="Form1" method="post" runat="server">
			<P></P>
			<P>
				<TABLE class="form" id="Table1" style="Z-INDEX: 101; LEFT: 7px; WIDTH: 528px; POSITION: absolute; TOP: 7px; HEIGHT: 460px"
					...
					<TR>
						<TD style="WIDTH: 356px; HEIGHT: 1px">
							<TABLE class="tabla" id="Table2" style="WIDTH: 328px; HEIGHT: 124px" cellSpacing="0" cellPadding="0"
								...
								<TR>
									...
									<TD style="WIDTH: 88px"><asp:textbox id="lblSubtotal" runat="server" Width="81px" MaxLength="14" Enabled="False" BackColor="#C0FFFF"></asp:textbox></TD>
									<TD><asp:textbox id="lblSubtotalS" runat="server" Width="81px" MaxLength="14" Enabled="False" BackColor="#C0FFFF"></asp:textbox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 127px">IGV&nbsp;
								...
								<TR>
									<TD style="WIDTH: 127px">Inafectos&nbsp;&nbsp;&nbsp;&nbsp;
										<asp:label id="Label1" runat="server" ForeColor="Red">(TAB)</asp:label></TD>
									<TD style="WIDTH: 88px"><asp:textbox id="txtInafectos" runat="server" Width="81px" MaxLength="14" AutoPostBack="True"></asp:textbox></TD>
									<TD><asp:textbox id="txtInafectosS" runat="server" Width="81px" MaxLength="14" AutoPostBack="True"></asp:textbox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 127px">Total&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD>
									<TD style="WIDTH: 88px"><asp:textbox id="lbltotal" runat="server" Width="81px" MaxLength="14" AutoPostBack="True"></asp:textbox></TD>
									<TD><asp:textbox id="lbltotalS" runat="server" Width="81px" MaxLength="14" AutoPostBack="True"></asp:textbox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 127px">&nbsp;</TD>
								...
								<TR>
									<TD style="WIDTH: 127px">Comisión Descontada</TD>
									<TD style="WIDTH: 88px">
										<asp:textbox id="txtComisionDescontada" runat="server" AutoPostBack="True" Width="81px" MaxLength="14"></asp:textbox></TD>
									<TD></TD>
								</TR>
							</TABLE>
							&nbsp;
