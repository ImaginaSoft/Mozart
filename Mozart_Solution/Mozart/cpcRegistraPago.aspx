<%@ Page Language="VB" AutoEventWireup="false" CodeFile="cpcRegistraPago.aspx.vb" Inherits="cpcRegistraPago" %>
...
<head runat="server">
	...
	<body >
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table4" style="Z-INDEX: 101; LEFT: 8px; WIDTH: 536px; POSITION: absolute; TOP: 8px; HEIGHT: 378px"
				cellSpacing="0" cellPadding="1" width="536" border="0" class="form">
				<TR>
					<TD style="HEIGHT: 20px">
						<P class="Titulo">&nbsp; Registra&nbsp;Pagos</P>
					</TD>
				</TR>
				<TR>
					<TD>
				...
				<TR>
					<TD style="HEIGHT: 266px">
						<TABLE class="tabla" id="Table1" style="WIDTH: 560px; HEIGHT: 272px" cellSpacing="0" cellPadding="0"
							width="560" border="1" borderColor="#cccccc">
							<TR>
								<TD style="WIDTH: 124px; HEIGHT: 13px">&nbsp;Tipo Documento</TD>
								<TD style="HEIGHT: 13px">
                                    <asp:dropdownlist id="ddlTipoDocumento" runat="server" 
                                        Width="288px" DataTextField="NomDocumento"
							...
							<TR>
								...
								<TD style="HEIGHT: 7px"><asp:dropdownlist id="ddlNumeroPedido" runat="server" 
                                        Width="420px" DataTextField="DesPedido"
							...
							<TR>
								<TD style="WIDTH: 124px; HEIGHT: 17px">&nbsp;Código autorización
								</TD>
								<TD style="HEIGHT: 17px"><asp:textbox id="txtCodAutoriza" runat="server" Width="168px" MaxLength="20"></asp:textbox></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD style="HEIGHT: 17px"><asp:textbox id="txtTipoCambio" runat="server" Width="93px" MaxLength="11" AutoPostBack="True"></asp:textbox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<asp:label id="lblpc" runat="server">Pago del Cliente</asp:label>&nbsp;
									<asp:textbox id="txtPagoCliente" runat="server" Width="91px" ForeColor="Silver" MaxLength="11"
										Enabled="False" BackColor="#C0FFFF"></asp:textbox>&nbsp;
									<asp:label id="lblSimbolo" runat="server"></asp:label></TD>
							</TR>
							<TR>
								<TD style="WIDTH: 124px; HEIGHT: 17px">&nbsp;Banco</TD>
								<TD style="HEIGHT: 17px"><asp:dropdownlist id="ddlBanco" runat="server" 
                                        Width="288px" DataTextField="NomBanco"
							...
							<TR>
								<TD style="HEIGHT: 27px" colSpan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
									...
									<asp:label id="lblNA" runat="server" Width="261px" CssClass="error"></asp:label></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
				<TR>
					<TD><asp:label id="lblmsg" runat="server" Width="410px"  CssClass="error"></asp:label></TD>
				</TR>
				<TR>
					<TD><asp:GridView id="dgDocumento" runat="server" Width="700px" Height="24px" CssClass="Grid" OnItemDataBound="ComputeSum"
